...
$usuarioNome = (string)($usuario["nome_completo"] ?? $usuario["nome"] ?? "Usuário TI TECH");
$usuarioTipo = (string)($usuario["tipo_usuario"] ?? "Colaborador");
$usuarioEmail = (string)($usuario["email"] ?? "");
...
<head>
    ...
    <link rel="stylesheet" href="css/pagina-base.css" />
    <link rel="stylesheet" href="css/dashboard-produtos.css" />
</head>
<body class="page-loading theme-dark dashboard-products-page" data-accent="teal">
    <div class="sidebar-backdrop" id="sidebarBackdrop" aria-hidden="true"></div>

    <aside class="app-sidebar" id="appSidebar" aria-label="Menu principal">
        <div class="sidebar-brand">
            <a class="brand-link" href="pagina-inicial.php" aria-label="Voltar para a página inicial">
                <img class="brand-logo" src="assets/logo-branca.png" alt="TI TECH Solutions" />
            </a>

            <button class="sidebar-close" id="closeSidebar" type="button" aria-label="Fechar menu lateral">
                <i class="bi bi-x-lg"></i>
            </button>
        </div>

        <div class="sidebar-user-card">
            <div class="sidebar-user-avatar" aria-hidden="true"><?php echo e($iniciais); ?></div>

            <div class="sidebar-user-info">
                <strong><?php echo e($usuarioNome); ?></strong>
                <span><?php echo e($usuarioTipo); ?></span>
                <?php if ($usuarioEmail !== ""): ?>
                    <small><?php echo e($usuarioEmail); ?></small>
                <?php endif; ?>
            </div>
        </div>
        ...
        <nav class="sidebar-nav" aria-label="Navegação do sistema">
            ...
            <a class="active" href="dashboard.php" aria-current="page">
        ...
        <a class="sidebar-logout" href="Backend/logout.php">
    ...
    <main class="app-main">
        <header class="topbar dashboard-topbar">
            <button class="menu-button" id="openSidebar" type="button" aria-label="Abrir menu lateral">
                <i class="bi bi-list"></i>
            </button>

            <div class="topbar-title">
                <span>Portal TI TECH</span>
        ...
        <section class="dashboard-hero" aria-labelledby="dashboardTitle">
            <div>
                ...
                <p>
                    Escolha o tipo de gráfico, filtre uma categoria específica e acompanhe quantos ativos existem em cada grupo.
                </p>
            </div>
            ...
            <article class="dashboard-panel main-chart-card">
                <div class="panel-heading">
                    <div>
                        ...
                        <p id="mainChartDescription">Distribuição dos ativos cadastrados por categoria de produto.</p>
                    </div>
