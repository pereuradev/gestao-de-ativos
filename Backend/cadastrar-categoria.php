...
// Endpoint de cadastro de categorias usadas no cadastro de ativos.
...
exigirPermissaoApi("cadastrar_categorias", "Cadastro de categorias");
...
try {
    ...
    if ($erro->getCode() === "23505") {
        responderCategoria(false, "Esta categoria ja esta cadastrada.", 409);
    }

    responderCategoria(false, "Nao foi possivel cadastrar a categoria agora.", 500);
} catch (Throwable) {
    responderCategoria(false, "Nao foi possivel cadastrar a categoria agora.", 500);
}
