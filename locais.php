...
<head>
  ...
  <link rel="stylesheet" href="css/locais.css?v=20260623-location-pin-focus" />
...
<body class="theme-dark page-loading">
  <div class="app-shell">
    ...
    <main class="main-area">
      ...
      <section class="locations-layout" aria-label="Cadastro e lista de localizacoes">
        ...
        <article class="content-card records-card location-records-card">
