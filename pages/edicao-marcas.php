...
// Lista marcas e prepara os dados usados pelo modal de edição e exclusão.
session_start();
...
<head>
  ...
  <script src="../js/pages/edicao-marcas.js?v=20260624-common-ui" defer></script>
...
<body class="theme-dark page-loading">
  <div class="app-shell">
    ...
    <main class="main-area">
      ...
      <!-- Contextualiza a manutenção das marcas do inventário. -->
      ...
      <!-- Indicadores gerais de marcas ativas e inativas. -->
      ...
      <!-- Filtros e tabela usados para selecionar a marca. -->
