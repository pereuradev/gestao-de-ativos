...
// Carrega grupos, membros e permissões para manutenção das regras de acesso.
session_start();
...
<body class="theme-dark page-loading">
  <div class="app-shell">
    ...
    <main class="main-area employee-registration-page group-registration-page group-edit-page">
      ...
      <!-- Contextualiza a manutenção dos grupos e de suas permissões. -->
      ...
      <!-- Indicadores gerais dos grupos, membros e permissões. -->
      ...
      <!-- Busca e cartões com o estado atual de cada grupo. -->
  ...
  <div class="edit-modal-backdrop group-modal-backdrop" id="groupEditModal" hidden>
    <!-- Modal que edita dados, membros e permissões como uma única operação. -->
